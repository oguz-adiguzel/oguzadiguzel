    ...
    <div className="w-full h-full">
      <div className={menu ? 'flex h-auto pt-0' : "flex flex-col lg:flex-row h-auto pt-5 lg:pt-40"}>
        <motion.div initial={{ opacity: 0, translateY: -200 }}
          ...
          <a href="/cv/my-cv.pdf" download="OĞUZ_ADIGÜZEL_CV.pdf" className={menu ? 'w-36 h-8 bg-blue-500 hover:w-32 duration-500 ease-in-out ml-20 cursor-pointer flex justify-end items-center mt-4' : "w-36 h-10 bg-blue-500 hover:w-32 duration-500 ease-in-out ml-5 lg:ml-32 flex justify-end items-center cursor-pointer mt-4"}>
