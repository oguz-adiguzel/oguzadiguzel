...
const Contact = ({ menu }) => {
  return (
    <div className={menu ? 'bg-contact-bg w-full h-[300px] bg-cover' : 'w-full h-[650px] mt-40 bg-contact-bg bg-cover'}>
      <div className='w-full h-full bg-[#000000e8] flex justify-end pr-20 items-center'>
        <div className={menu ? 'w-1/3 bg-black py-4' : 'w-1/4 py-16 bg-black'}>
